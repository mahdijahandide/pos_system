            ...
            children: [
              Row(
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    color: isPercent.isTrue?Colors.green.withOpacity(0.6):Colors.grey.withOpacity(0.5),
                    child: Center(child: CustomText().createText(title: '%',size: 22,fontWeight: FontWeight.bold)),
                  ),
                ),
                InkWell(
                  onTap: (){isPercent=false.obs;controller.update();},
                  child: Container(
                    width: 100,
                    height: 65,
                    padding: const EdgeInsets.symmetric(horizontal: 15,vertical: 12),
                    color: isPercent.isFalse?Colors.green.withOpacity(0.6):Colors.grey.withOpacity(0.5),
                    child: Center(child: CustomText().createText(title: '\$',size: 22,fontWeight: FontWeight.bold)),
                  ),
                ),
              ],),
              ...
              CustomTextField().createTextField(
                  ...
                  onSubmitted: (_)async{
                    if(isPercent.isFalse){
                      Get.find<CartController>().discountAmount=double.parse(discountController.text.toString());
                    }else{
              ...
              Container(
                ...
                child: VirtualKeyboard(
                  ...
                  type: VirtualKeyboardType.Numeric, textController: discountController,
                ),
              ),
            ],
          ),
