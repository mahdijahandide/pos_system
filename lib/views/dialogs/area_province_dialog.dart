          ...
          onTap: () {
            if (Get.find<CartController>().selectedCountryId.isNotEmpty &&
              ...
              var data = jsonEncode(<String, dynamic>{
                "id": 0,
                "country_id":
                    int.parse(Get.find<CartController>().selectedCountryId),
                "state_id":
                    int.parse(Get.find<CartController>().selectedProvinceId),
                "area_id": int.parse(Get.find<CartController>().selectedAreaId),
                "country_name":
                    Get.find<CartController>().selectedCountryName.value,
                "state_name":
              ...
              Get.find<AddressController>().selectedAddress =
                  CustomerAddressModel(data: jsonDecode(data));
