          ...
          actions: [
            InkWell(
              ...
              child: Padding(
                ...
                child: Get.find<UserController>().hasEdit.isFalse
              ...
              children: [
                Get.find<UserController>().hasEdit.isTrue
                    ? CustomTextField().createTextField(
                        hint: 'name',
                        height: 50,
                        controller: Get.find<UserController>().nameController)
                ...
                Get.find<UserController>().hasEdit.isTrue
                    ? CustomTextField().createTextField(
                        hint: 'enter email',
                        height: 50,
                        controller: Get.find<UserController>().emailController)
                    : CustomText().createSpaceKeyVal(
                        keyText: 'email'.tr,
                ...
                Get.find<UserController>().hasEdit.isTrue
                    ? CustomTextField().createTextField(
                        hint: 'enter mobile',
                        height: 50,
                        controller: Get.find<UserController>().mobileController)
                    : CustomText().createSpaceKeyVal(
                        keyText: 'Mobile',
